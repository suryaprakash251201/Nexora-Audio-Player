...
class AlbumsApi {
  ...
  Future<Paginated<Album>> getAlbums({int page = 1, int limit = 20, String? query, CancelToken? cancelToken}) async {
    final res = await _client.get(ApiConstants.albums, query: {
      'page': page,
      'limit': limit,

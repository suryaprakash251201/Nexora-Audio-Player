...
class _FullPlayerScreenState extends ConsumerState<FullPlayerScreen>
            ...
            children: [
              AppBar(
                ...
                actions: [
                  IconButton(
                    icon: Icon(
                      _showCassette ? Icons.album : Icons.audiotrack,
                      color: Colors.white,
                    ),
                    onPressed: () =>
                      ...
                      Row(
                        children: [
                          if (track.extras?['codec'] != null)
                            _badge(
                              (track.extras!['codec'] as String).toUpperCase(),
                            ),
                          ...
                          if (track.extras?['bitrate'] != null)
                            _badge('${track.extras!['bitrate']} kbps'),
                        ],
                      ),
  ...
  Widget _artPlaceholder() => Container(
    ...
    child: const Center(
      child: Icon(Icons.music_note, size: 100, color: AppColors.textMuted),
    ),
  );

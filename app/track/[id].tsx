...
export default function NowPlayingScreen() {
  ...
  return (
    <View style={styles.root}>
      {/* Immersive background — subtle gradient + blurred artwork behind */}
      ...
      <View style={{ flex: 1, paddingTop: insets.top + 6, paddingBottom: insets.bottom + 10 }}>
        {/* Top bar */}
        <View style={styles.topBar}>
          ...
          <Pressable onPress={() => router.push("/info/[id]" as any)} hitSlop={12} style={styles.topBtn}>
        ...
        <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: 12, gap: 14 }} showsVerticalScrollIndicator={false}>
          ...
          {/* Title / artist / album */}
          <View style={{ gap: 4 }}>
            <Pressable onPress={() => { /* favorite toggle lands in M11 */ }}>
          ...
          <View style={styles.controls}>
            <Pressable onPress={() => playback.setShuffle(!isShuffle)} style={[styles.ctrlGhost, isShuffle && styles.ctrlActive]}>
              <Ionicons name="shuffle" size={20} color={isShuffle ? colors.accent : "rgba(255,255,255,0.9)"} />
            </Pressable>
            <Pressable onPress={() => void playback.prev()} style={styles.ctrlBig}>
            ...
            <Pressable onPress={() => void playback.next()} style={styles.ctrlBig}>
          ...
          <View style={styles.bottomRow}>
            ...
            <Pressable onPress={() => { /* queue panel M18 */ }} style={styles.bottomAction}>
...
const styles = StyleSheet.create({
  ...
  nowPlaying: { color: "rgba(255,255,255,0.85)", fontSize: 11, fontWeight: "800", letterSpacing: 1.2 },
  nowSource: { color: "rgba(255,255,255,0.65)", fontSize: 11 },
  ...
  losslessLabel: { color: "#fff", fontSize: 10, fontWeight: "800", letterSpacing: 0.6 },
  title: { flex: 1, color: "#fff", fontSize: 20, fontWeight: "800", letterSpacing: -0.3, lineHeight: 22 },
  artist: { color: "rgba(255,255,255,0.85)", fontSize: 14, fontWeight: "600" },
  album: { color: "rgba(255,255,255,0.6)", fontSize: 12 },
  timeRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  time: { color: "rgba(255,255,255,0.7)", fontSize: 11, fontWeight: "600", fontVariant: ["tabular-nums"] as any },
  ...
  bottomLabel: { color: "rgba(255,255,255,0.9)", fontSize: 12, fontWeight: "700" },
});